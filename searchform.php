...
<form role="search" method="get" class="form-inline my2 my-lg-0" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	...
	<button type="submit" class="btn <?php echo esc_attr( get_theme_mod( 'search_color', 'btn-theme' ) ); ?> my-2 my-sm-0" id="searchsubmit" value="<?php esc_attr_e( 'Search', 'best-reloaded' ); ?>" /><?php esc_html_e( 'Search', 'best-reloaded' ); ?></button>
</form>

		...
		<div id="main_content" role="main">
			<div class="row">
				<div class="col-sm-12 not-found-404">
					...
					<p class="hero-p"><?php esc_html_e( 'Sorry, but the page you were trying to view does not exist.', 'best00-reloaded' ); ?><br/><?php esc_html_e( 'It looks like this was the result of either:', 'best-reloaded' ); ?></p>
					<ul>

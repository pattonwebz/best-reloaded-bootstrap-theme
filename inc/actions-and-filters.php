...
if ( ! function_exists( 'best_reloaded_remove_recent_comments_style' ) ) {
	/**
...
if ( ! function_exists( 'best_reloaded_add_class_the_tags' ) ) {
	/**
...
if ( ! function_exists( 'best_reloaded_jptweak_remove_share' ) ) {
	/**
...
if ( ! function_exists( 'best_reloaded_output_navbar_brand' ) ) {
	/**
...
if ( ! function_exists( 'best_reloaded_output_post_meta' ) ) {
	/**
...
if ( ! function_exists( 'best_reloaded_layout_output_classnames' ) ) {
	/**
...
if ( ! function_exists( 'best_reloaded_filter_layout_classnames_output' ) ) {
	/**
...
if ( ! function_exists( 'best_reloaded_output_navbar_classes' ) ) {
	/**
...
if ( ! function_exists( 'best_reloaded_do_breadcrumbs' ) ) {
	/**

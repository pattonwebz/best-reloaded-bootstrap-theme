...
final class Best_Reloaded_Customize {
	...
	public function panels( $wp_customize ) {
		...
		$wp_customize->add_panel(
			'best_reloaded_theme_settings_panel',
			array(
...
<p><?php esc_html_e( 'If you like this theme consider giving it a ', 'best-reloaded' ); ?><a href="<?php echo esc_url( 'https://wordpress.org/support/theme/best-reloaded/reviews/ ' ); ?>" target="_blank"><?php esc_html_e( '5 star rating', 'best-reloaded' ); ?></a>.</p>
	...
	public function enqueue_control_scripts() {
		wp_enqueue_script( 'best-reloaded-customize-controls', trailingslashit( get_template_directory_uri() ) . 'inc/customizer/js/customize-controls.js', array( 'customize-controls' ), '1', true );
		wp_enqueue_style( 'best-reloaded-customize-controls', trailingslashit( get_template_directory_uri() ) . 'inc/customizer/css/customize-controls.css', array(), '1' );
	}
}
